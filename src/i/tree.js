...
return this._is_wildcard===undefined?this._is_wildcard= /^_./ .test(this.resolved_data() ) :this._is_wildcard} ,meta_level:function() {;
return this._meta_level===undefined?this._meta_level= /^(@*)/ .exec(this.resolved_data() ) [1] .length:this._meta_level} ,match_arity:function() {;
return this._match_arity===undefined?this._match_arity= (function(it) {return(it&& +it[1] ) } ) .call(this, ( /^_.*@(\d+)$/ .exec(this.resolved_data() ) ) ) :this._match_arity} ,match_meta_level:function() {;
return this._match_meta_level===undefined?this._match_meta_level= /^_(@*)/ .exec(this.resolved_data() ) [1] .length:this._match_meta_level} ,without_arity:function() {;
