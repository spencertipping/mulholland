...
return(pattern) .can_match(this) && ( (pattern) .match(this) || (function(xs) {var x,x0,xi,xl,xr;
for(var x=xs[0] ,xi=0,xl=xs.length,x_3_seRFvVeCRBk6yJbPKk53BD;
xi<xl;
 ++xi) {x=xs[xi] ;
if(x_3_seRFvVeCRBk6yJbPKk53BD= ( (x) .first(pattern) ) )return x_3_seRFvVeCRBk6yJbPKk53BD}return false} ) .call(this,this) ) } ,match:function(t,m) {;
return(this) .can_match(t) && (this) .level_matches(t) && (m|| (m= { } ) ) && ( ( (this.is_wildcard() ) && (m[this.resolved_data() ] ? (m[this.resolved_data() ] ) .match(t) :m[this.resolved_data() ] =t) ) , (this) .children_match(t,m) &&m) } ,replace:function(m) {;
