...
return this.length<=t.length&& (this) .can_match(t) && (this) .level_matches(t) && ! !m|| (m= {_:t} ) && ( ( !this.is_wildcard() ) || ( (m[this.without_arity() ] ? (m[this.without_arity() ] ) .match(t) :m[this.without_arity() ] =t) ) ) && (this) .children_match(t,m) &&m} ,replace:function(m) {;
