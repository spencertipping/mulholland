...
return xr} ) .call(this,Array.prototype.slice.call( (this) ) ) ) } ,with_children:function(xs) {;
return new this.constructor(this.data,xs) } ,push:function(x) { (this[this.length++ ] =x) ;
...
return m&& ( (function(it) {return(it&&this.length?it.with_children( (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( (x.replace(m) ) ) ;
return xr} ) .call(this,this) ) :it) } ) .call(this, (m[this.resolved_data() ] ) ) || (this) .map(function(_) {return _.replace(m) } ) ) } ,can_match:function(t) {;
