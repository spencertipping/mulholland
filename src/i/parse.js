...
return apply_until(t.f&1?function(_) {return _.f&8||_.r>=t.p} :function(_) {return _.f&8||_.p>t.p} ) } ,maybe_join=function() {;
...
return t.f===12?close_ternary(t) : ( ( ( (apply_until(opener) ) , (expect_value=false) ) ) , (apply_unary() ) ) } ,observe_vop=function(t) {;
...
return t.f===8} ,opener=function(t) {var f=t.f;
