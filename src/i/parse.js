...
return v===8?apply_ternary() :v&2?apply_unary() :apply_binary() } ,apply_until=function(f) {;
return(function(xs) {var x,x0,xi,xl,xr;
for(var x=xs,xi=0,x0,xl;
x0= (operators.length&& !f(top() ) ) ;
 ++xi)x= (apply() ) ;
return x} ) .call(this,null) } ,apply_operator=function(t) {;
return apply_until(t.f&1?function(_) {return _.p>=t.p} :function(_) {return _.p>t.p} ) } ,maybe_join=function() {;
return( (expect_value=== (expect_value=false) ) && (observe_binary(join) ) ) } ,observe=function(t) {;
return t.f?observe_operator(t) :observe_value(t) } ,observe_value=function(t) {;
return( (maybe_join() ) , ( (values) .push(t.id) ) ) } ,observe_operator=function(t) {;
