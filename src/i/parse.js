...
for(var k_b_hZPQLC$yDOvAIy0WJsU7$n in xs)if(Object.prototype.hasOwnProperty.call(xs,k_b_hZPQLC$yDOvAIy0WJsU7$n) )x=xs[k_b_hZPQLC$yDOvAIy0WJsU7$n] ,xr[k_b_hZPQLC$yDOvAIy0WJsU7$n] = ( -x) ;
...
return(function(xs) {var x,x0,xi,xl,xr;
for(var x=xs[0] ,xi=0,xl=xs.length,x_3_hZPQLC$yDOvAIy0WJsU7$n;
xi<xl;
 ++xi) {x=xs[xi] ;
if(x_3_hZPQLC$yDOvAIy0WJsU7$n= (x.test(c) &&xi+1<<2) )return x_3_hZPQLC$yDOvAIy0WJsU7$n}return false} ) .call(this,base_operators) } ,shaded_precedence=function(c) {;
