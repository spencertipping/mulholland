...
for(var k_b_QctsvgW34papZV0ASboifV in xs)if(Object.prototype.hasOwnProperty.call(xs,k_b_QctsvgW34papZV0ASboifV) )x=xs[k_b_QctsvgW34papZV0ASboifV] ,xr[k_b_QctsvgW34papZV0ASboifV] = ( -x) ;
...
return(function(xs) {var x,x0,xi,xl,xr;
for(var x=xs[0] ,xi=0,xl=xs.length,x_3_QctsvgW34papZV0ASboifV;
xi<xl;
 ++xi) {x=xs[xi] ;
if(x_3_QctsvgW34papZV0ASboifV= (x.test(c) &&xi+1<<2) )return x_3_QctsvgW34papZV0ASboifV}return false} ) .call(this,base_operators) } ,shaded_precedence=function(c) {;
