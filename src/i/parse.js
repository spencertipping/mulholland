...
for(var k_b_mDuUGwINQ9YxYug7qTBgJx in xs)if(Object.prototype.hasOwnProperty.call(xs,k_b_mDuUGwINQ9YxYug7qTBgJx) )x=xs[k_b_mDuUGwINQ9YxYug7qTBgJx] ,xr[k_b_mDuUGwINQ9YxYug7qTBgJx] = ( -x) ;
...
return(function(xs) {var x,x0,xi,xl,xr;
for(var x=xs[0] ,xi=0,xl=xs.length,x_3_mDuUGwINQ9YxYug7qTBgJx;
xi<xl;
 ++xi) {x=xs[xi] ;
if(x_3_mDuUGwINQ9YxYug7qTBgJx= (x.test(c) &&xi+1<<2) )return x_3_mDuUGwINQ9YxYug7qTBgJx}return false} ) .call(this,base_operators) } ,shaded_precedence=function(c) {;
