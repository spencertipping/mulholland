...
return( {l:real_left,r:real_right,id:intern(canonical) ,u:unary} ) } ) .call(this) } ,join=parse_operator( '#' ) ,empty_value=new syntax( '@' ) ,parse=function(ts) {;
...
return( (function(it) {return(apply_all() ) } ) .call(this, ( (function(xs1) {var x2,x01,xi1,xl1,xr1;
...
return xr1} ) .call(this,ts) ) ) ) ) } ) .call(this) } ;
