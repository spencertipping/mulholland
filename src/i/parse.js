...
for(var k_b_wBItPZ1JtAJrD8gqQ9N6qg in xs)if(Object.prototype.hasOwnProperty.call(xs,k_b_wBItPZ1JtAJrD8gqQ9N6qg) )x=xs[k_b_wBItPZ1JtAJrD8gqQ9N6qg] ,xr[k_b_wBItPZ1JtAJrD8gqQ9N6qg] = ( -x) ;
...
return(function(xs) {var x,x0,xi,xl,xr;
for(var x=xs[0] ,xi=0,xl=xs.length,x_3_wBItPZ1JtAJrD8gqQ9N6qg;
xi<xl;
 ++xi) {x=xs[xi] ;
if(x_3_wBItPZ1JtAJrD8gqQ9N6qg= (x.test(c) &&xi+1<<2) )return x_3_wBItPZ1JtAJrD8gqQ9N6qg}return false} ) .call(this,base_operators) } ,shaded_precedence=function(c) {;
