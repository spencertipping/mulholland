...
for(var xl=xs.length,xi=xl-1,x=xs[xi] ,x_3_fSvSKODTfrIT0z4se82L1r;
xi>=0;
 --xi) {x=xs[xi] ;
if(x_3_fSvSKODTfrIT0z4se82L1r= ( (x[1] ) .replace(x[0] .match(t) ) ) )return x_3_fSvSKODTfrIT0z4se82L1r}return false} ) .call(this,current_list) } ,fixed_point=function(t) {;
...
for(var x=xs[0] ,xi=0,xl=xs.length,x_3_fSvSKODTfrIT0z4se82L1r;
xi<xl;
 ++xi) {x=xs[xi] ;
if(x_3_fSvSKODTfrIT0z4se82L1r= (xi>ri&& (x[0] ) .match(r[0] ) ) )return x_3_fSvSKODTfrIT0z4se82L1r}return false} ) .call(this,rs) ) ||rr.push(r) ;
