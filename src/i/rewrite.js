...
xi>=0;
 --xi) {x=xs[xi] ;
if(x1= (x[1] .constructor===Function?x[1] .call(rewrite, (x[0] ) .match(t) ) : (x[1] ) .replace(x[0] .match(t) ) ) )return x1}return false} ) .call(this,current_list) } ,deep_rewriter=function() {var b=pattern_bloom() ;
