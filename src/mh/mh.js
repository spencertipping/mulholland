...
return xs} ) .call(this,e.flatten_all( ';' ) ) :e.resolved_data() === '=' ?define(e) :e.resolved_data() === '=@js' ?js_define(e) :e.resolved_data() === '//' ?evaluate(rewrite(e) ) :cc(e) } ,cc=function(x) {;
return( ( ( (options) || (defaults) ) ) ) .cc(x) } ,rewrite=function(t) {;
return c.toplevel.extend(t[1] .flatten_all( ';' ) ) (t[0] ) } ,js_define=function(equation) {;
