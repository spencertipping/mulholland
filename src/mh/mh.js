...
return(function( ) {var mh=$.mulholland.mh() ,mhc=function(t) {;
return mh(t, {cc:function(_) {return output(_.as_js() .toString() ) } } ) } ;
return( (function(xs) {var x,x0,xi,xl,xr;
...
return( (this) .parse(s) ) .flatten_all( ';' ) } ,toplevel:$.mulholland.rewriter( [ ] ) } } ,mh=function() {;
var result=function(s,options) {;
return(function( ) {var evaluate=function(t) {var e=c.toplevel(t) ;
return e.resolved_data() === '=' ?define(e) :e.resolved_data() === '//' ?evaluate(rewrite(e) ) :cc(e) } ,cc=function(x) {;
return( ( ( (options) || (defaults) ) ) ) .cc(x) } ,rewrite=function(t) {;
return c.toplevel.extend(t[1] .flatten_all( ';' ) ) (t[0] ) } ,define=function(equation) {;
...
return result} ;
return( {mh_main:mh_main,mh_offline:mh_offline,mh_repl:mh_repl,context:context,mh:mh} ) } ) .call(this) ) ) } ) .call(this) } ) ;
