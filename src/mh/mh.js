caterwaul.module( 'mulholland.mh' ,function($) { (function( ) {var read_file=function(f) {;
...
return argv.length? (function( ) {var mh=$.mulholland.mh() ;
...
return xr} ) .call(this,argv) ) ) ) } ) .call(this) :$.mulholland.mh_repl(argv) } ,$.mulholland.mh_repl=function(argv) {;
...
return(require( 'repl' ) .start( 'mh> ' ,undefined,evaluator) ) } ) .call(this) } ,$.mulholland.mh=function() {;
