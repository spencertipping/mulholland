caterwaul.module( 'mulholland.mh' , (function(qse) {var result1= (function($) { (function( ) {var source_for=function(argv) {;
...
return xs1} ) .call(this,e.flatten_all( ';' ) ) :d=== '=' ?define(e) :d=== '@-' ?js_evaluate(e) :d=== '=@' ?js_define(e) :d=== '/-' ?evaluate(rewrite(e) ) :options.cc( (e) .replace( { } ) ) } ,options=$.merge( { } ,defaults,specified_options) ,empty=c.parse.syntax(c.parse.intern( '@' ) ) ,js_macroexpand=$( ':all' ) ,rewrite=function(t) {;
...
return compile( (qse) .replace( {_body:js} ) ) } ,js_define=function(equation) {;
...
result1.caterwaul_expression_ref_table= {qse: ( "new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"match\" ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"&&\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"match\" ) ) ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"_body\" ) ) ) ) ) ) ) )" ) } ;
return(result1) } ) .call(this,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "match" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "&&" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "match" ) ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_body" ) ) ) ) ) ) ) ) ) ) ;
