...
return(function( ) {var mh= (function(it) {return(evaluate_js_modules(argv) ) ,it} ) .call(this, ($.mulholland.mh() ) ) ,cc=contains_short(argv, 'r' ) ?function(_) {return $.compile(_.as_js() .guarded() ,environment) } :function(_) {return output(_.as_js() .guarded() .toString() ) } ,ccs= {cc:cc} ,environment= {c:$,mh:mh,require:require,process:process} ,mhc=function(t) {;
return mh(t,ccs) } ;
return( (function(xs1) {var x1,x01,xi1,xl1,xr1;
...
return xs1} ) .call(this,e.flatten_all( ';' ) ) :e.resolved_data() === '=' ?define(e) :e.resolved_data() === '@js' ?js_evaluate(e) :e.resolved_data() === '=@js' ?js_define(e) :e.resolved_data() === '/-' ?evaluate(rewrite(e) ) :options.cc(e) } ,options=$.merge( { } ,defaults,specified_options) ,js_macroexpand=$( 'js_all' ) ,empty=new c.parse.syntax(c.parse.intern( '@' ) ) ,rewrite=function(t) {;
