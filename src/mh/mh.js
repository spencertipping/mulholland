...
return match&&$.compile( (toplevel_rewriter(match._x) ) .as_js(parse) ,environment) } ,environment= {caterwaul:$,require:require,parse:parse,define:define,rewrite:rewrite,compile:compile} ,assert_valid_rewrite=function(tree) {;
