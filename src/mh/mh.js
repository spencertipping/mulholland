caterwaul.module( 'mulholland.mh' ,function($) { (function( ) {var parse=$.mulholland() ,js=$.mulholland.js(parse) ,rewrite_form=parse( '_x /@ [_y]' ) ,rewrite=function(match) {;
return match&&$.mulholland.rewriter(match._y.flatten( ',' ) ) (match._x) } ,read_file=function(f) {;
