...
return(function( ) {var mh=$.mulholland.mh() ,cc=contains_short(argv, 'r' ) ?function(_) {return $.compile(_.as_js() .guarded() ,environment) } :function(_) {return output(_.as_js() .guarded() .toString() ) } ,ccs=$.merge( {cc:cc} , (contains_short(argv, 'v' ) &&verbose_ccs() ) ) ,environment= {c:$,mh:mh,require:require,process:process} ,mhc=function(t) {;
return mh(t,ccs) } ;
return( (function(xs) {var x,x0,xi,xl,xr;
