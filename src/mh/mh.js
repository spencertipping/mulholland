...
return process.stdout.write(t+ ';\n' , 'utf8' ) } ,log=function(message,t) {;
return process.stderr.write( ( '[mh.' + (message) + '] ' + (t.toString() ) + '\n' ) , 'utf8' ) } ,mh_for=function(argv) {;
return(function(it) {return( ( (contains_short(argv, 'v' ) ) && ( (function( ) {var fix=it.context.toplevel.fix;
return(it.context.toplevel.fix=function(x) {;
return(function(it) {return(log( 'fix' ,it) ) ,it} ) .call(this, (fix(x) ) ) } ) } ) .call(this) ) ) ) ,it} ) .call(this, ($.mulholland.mh() ) ) } ,defaults= {cc:output,define_cc:function(_) {return null} ,js_define_cc:function(_) {return null} } ;
...
return(function( ) {var mh=mh_for(argv) ,cc=contains_short(argv, 'r' ) ?function(_) {return $.compile(_.as_js() .guarded() ,environment) } :function(_) {return output(_.as_js() .guarded() .toString() ) } ,ccs=$.merge( {cc:cc} , (contains_short(argv, 'v' ) &&verbose_ccs() ) ) ,environment= {c:$,mh:mh,require:require,process:process} ,mhc=function(t) {;
return mh(t,ccs) } ;
return( (function(xs) {var x,x0,xi,xl,xr;
...
return(function( ) {var mh=mh_for(argv) ,ccs=contains_short(argv, 'v' ) &&verbose_ccs() ,evaluator=function(s,_1,_2,cc) {;
...
xi<xl;
 ++xi)x=xs[xi] , (mh(x,ccs) ) ;
return xs} ) .call(this,source_for(argv) ) ) , (require( 'repl' ) .start( 'mh> ' ,undefined,evaluator) ) ) ) } ) .call(this) } ,context=function() {;
